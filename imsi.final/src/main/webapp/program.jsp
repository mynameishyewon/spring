            ...
            <div class="header-content">
                <div class="row v-center">
                    <div class="col-lg-4 z-index-1 tablet-lg-top-45">
                        ...
                        <h2 class="page-title mb-20">Program 구경</h2>
                        <p class="header-text fw-regular fs-18">무엇을 봐야할지 망설여지신다구요? <br>지금'위티'들의 추천 OTT를 확인하세요!</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <a href="index1.html" class="demo-item-link" target="_blank">
                            <div class="card">
