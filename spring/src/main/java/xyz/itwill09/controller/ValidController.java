...
//전달값 검증 방법
//요청 처리 메소드의 매개변수에 저장될 Command 객체의 필드에 저장될 전달값 검증 - Spring Validation
...
//@Valid 어노테이션을 사용하여 검증 처리 되도록 설정
//4.Command 객체가 저장될 DTO 클래스의 필드에 검증 관련 어노테이션을 사용하여 전달값 검증
